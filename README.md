...
**70% of the credit belongs to [jbowens](https://github.com/jbowens) for this wonderful creation! + 29% to [banool](https://github.com/banool/)**
...
This is a modified version of the 'modified' original Codenames game where you use pictures instead of words. Look below for instructions on how to use your own images!
...
```
cd $GOPATH
go get github.com/katorek/codenames-pictures/...
